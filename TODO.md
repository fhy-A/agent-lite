# Code TODO  _上次更新：2026-07-18 17:42_
...
- [ ] **退役旧浏览器 Agent 循环** — 四种权限的新任务均已由服务端 AgentRun 单一持有；保留一段历史 `executionOwner=browser` 检查点兼容期，补齐迁移/过期策略后删除 `app.js` 中不再服务新任务的编排代码。详见 [`docs/SERVER_AGENT_LOOP_PLAN.md`](docs/SERVER_AGENT_LOOP_PLAN.md)。
