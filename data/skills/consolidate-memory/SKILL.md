...
description: 反思式整理记忆文件——合并重复内容、修复过时信息、精简索引，让后续会话能快速定位关键信息。
keywords: 整理+记忆, 合并+记忆, 清理+记忆, 去重, 记忆维护, consolidate+memory
tools: list_files, read_file, write_file, glob_files, search_files
---
...
Update `MEMORY.md` so it stays under 200 lines and ~25KB. One line per entry, under ~150 chars: `- 标题 + file.md 路径 + 一句话摘要`
