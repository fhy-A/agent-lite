...
**场景**: 建筑、制造、物流、工程
**色板**: 主色 `#4A4A4A`、辅色 `#8C8C8C`、背景 `#F0EFEB`、强调 `#D35D2C`、文字 `#2B2B2B`

---

#### 11. 暗夜模式 Dark Mode
**场景**: 代码演示、终端风格、开发者工具、晚间展示
**色板**: 主色/背景 `#1A1B26`、面板 `#414868`、强调 `#7DCFFF`、文字 `#C0CAF5`
**功能色**: 正向 `#9ECE6A`、负向 `#F7768E`

---

#### 12. 杂志编辑 Editorial
**场景**: 设计作品集、时尚、媒体、品牌手册
**色板**: 主色 `#1C1C1C`、辅色 `#E63946`、背景 `#FFFBF5`、强调 `#457B9D`、文字 `#2C2C2C`
