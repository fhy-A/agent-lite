---
name: hyperframes
description: 使用 HyperFrames HTML 创建和修改视频合成、动画、片头、字幕、旁白、音频响应视觉与场景转场。用于 HTML 视频、宣传片、动态图文、字幕同步、节拍动画和视频渲染工作流；不适用于普通网页 UI 动画。
keywords: 做视频, 生成视频, 视频动画, 视频合成, 宣传片, 片头, 片尾, 字幕, 旁白, 转场, 音频可视化, 节拍动画, 动态图文, HyperFrames, hyperframes video, html video, motion graphics, title card, captions, subtitles, voiceover, audio reactive, scene transition
tools: list_files, glob_files, search_files, read_file, propose_edit, write_file, run_command, web_fetch
---
