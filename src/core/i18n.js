(function initializeCodeI18n(global) {
  ...
  const I18N = {
    zh: {
      ...
      connectWorkbarTitle: "连接到 Workbar", connectWorkbarDesc: "登录 Workbar 后即可在 Code 中使用模型和同步 API Key。",
    ...
    en: {
      ...
      connectWorkbarTitle: "Connect to Workbar", connectWorkbarDesc: "Sign in to Workbar to use models and sync API Keys in Code.",
